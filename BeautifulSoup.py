...
our_search_words = f"{first_drug}+{second_drug}+{disease}"
no_interaction_set = {
    'nointeraction',
    'nointeractions',
    'nopain',
...
class LinksGetter:
    def __init__(self, our_search_words):
        self.our_search_words = our_search_words
...
obiekt = LinksGetter(searching_words)
obiekt.get_page_content()
obiekt.get_list_of_links()
print(obiekt.list_of_article_links)
list_of_objects = [Filter(x) for x in obiekt.list_of_article_links]
